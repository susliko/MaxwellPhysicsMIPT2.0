package IdealGas.experiments.plot.PlotDistribution;
...
/**
 * Processes IdealGas distribution charts
 */
public class PlotMaxwell extends PlotDistribution {
    /**
     * IdealGas Distribution parameter. m / kt.
     */
    private double a;

    /**
     * IdealGas Distribution parameter. m / (2kT).
     */
    private double b;

    /**
     * PlotMaxwell class constructor.
     * Builds IdealGas distribution, reserves data series for real distribution,
     ...
     * Uses two-dimensional IdealGas distribution.
     *
     * @param v velocity.
